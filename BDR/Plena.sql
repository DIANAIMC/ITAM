...
create table paciente(
	...
	genero enum ('Mujer','Hombre','Mujer Transgénero','Hombre Transgénero','Género no binario') not null, --
...
create table ginecologia(
	...
	menstruacion enum ('Antes de los 10 años','De los 10 años a los 14 años','Después de los 14 años'),
	...
	metodo_anticonceptivo enum ('Condón','Mirena','Kyleena','DIU de cobre', 'DIU de plata','Implante subdérmico','Anticonceptivos orales combinados',
	'Anillo vaginal', 'Parche', 'Inyección', 'Ciclo natural', 'Espermicidas', 'Coitus Interruptus', 'Ligación o corte de trompas uterinas',
	'Vasectomía','Ninguno') not null -- ¿Qué pasa si usa varios métodos?
);
...
create table nutricion(
	...
	tipo_ejercicio enum ('Caminar','Elíptica','Bicicleta estática', 'Pesas o ejercicios de fuerza', 'Yoga',
	'Actividades al aire libre', 'Otros') not null--¿qué pasa si hace varias de estas actividades?
);
...
create table preocupacion(
	...
	tiempo_preocupacion enum('Hace más de un mes', 'Hace más de 2 semanas','Hace menos de 2 semanas') not null,
